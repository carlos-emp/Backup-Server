...
quiet_cmd__home_rockanalex_node_node_v0_12_2_deps_v8_tools_gyp_v8_gyp_v8_external_snapshot_target_run_mksnapshot__external_ = ACTION _home_rockanalex_node_node_v0_12_2_deps_v8_tools_gyp_v8_gyp_v8_external_snapshot_target_run_mksnapshot__external_ $@
cmd__home_rockanalex_node_node_v0_12_2_deps_v8_tools_gyp_v8_gyp_v8_external_snapshot_target_run_mksnapshot__external_ = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps/v8/tools/gyp; mkdir -p $(builddir) $(obj).$(TOOLSET)/v8_external_snapshot/geni; "$(builddir)/mksnapshot" --log-snapshot-positions --logfile "$(obj).$(TOOLSET)/v8_external_snapshot/geni/snapshot.log" "$(obj).$(TOOLSET)/v8_external_snapshot/geni/snapshot.cc" --startup_blob "$(builddir)/snapshot_blob.bin"
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: $(builddir)/mksnapshot FORCE_DO_CMD
	$(call do_cmd,_home_rockanalex_node_node_v0_12_2_deps_v8_tools_gyp_v8_gyp_v8_external_snapshot_target_run_mksnapshot__external_)
...
action__home_rockanalex_node_node_v0_12_2_deps_v8_tools_gyp_v8_gyp_v8_external_snapshot_target_run_mksnapshot__external__outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(builddir)/snapshot_blob.bin
...
$(OBJS): | $(action__home_rockanalex_node_node_v0_12_2_deps_v8_tools_gyp_v8_gyp_v8_external_snapshot_target_run_mksnapshot__external__outputs)
...
$(obj).target/deps/v8/tools/gyp/libv8_external_snapshot.a: | $(action__home_rockanalex_node_node_v0_12_2_deps_v8_tools_gyp_v8_gyp_v8_external_snapshot_target_run_mksnapshot__external__outputs)

# Preserve order dependency of special output on deps.
$(action__home_rockanalex_node_node_v0_12_2_deps_v8_tools_gyp_v8_gyp_v8_external_snapshot_target_run_mksnapshot__external__outputs): | $(builddir)/mksnapshot $(obj).target/deps/v8/tools/gyp/js2c.stamp $(obj).target/deps/v8/tools/gyp/natives_blob.stamp
